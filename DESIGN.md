# prompt-builder · DESIGN.md — 设计合同 v2(方向已定:一号海报 One-Sheet)
...
- 动效:120-200ms ease-out,只动 opacity/transform;页面加载可做一次编排式 stagger(海报音量);工作台内动效克制到反馈级。
...
*v2 · 2026-07-19 · P6-B 实证闭环(美指 4 方向→双盲审→验收官 ACCEPT→Eric 选定 One-Sheet)· 施工正本 cmrr78lrc0dg307adv66x9c2z · 上版 v1(过渡合同)@7bed1355*
